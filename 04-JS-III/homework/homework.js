...
function diaDeLaSemana(numeroDeDia) {
  ...
  //Escribe tu código aquí   
  if (numeroDeDia < 1 || numeroDeDia > 7) return "Amigo pone un numero del uno al siete, si no no hacemos nada";
...
function breakStatement(numero) {
  ...
  //   if (numero === i) break;
  // };
  // if (nuevosValores.length < 10) return "Se interrumpió la ejecución";
  var nuevosValores = [];
  for (var i = 0; i < 10; i++) {
    numero += 2;
    nuevosValores.push(numero);
